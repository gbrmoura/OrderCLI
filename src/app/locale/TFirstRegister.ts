...
export const TFirstRegister: ZLanguageData = {
  pt: {
    ...
    mdl_fr_fail: 'Falha ao Efetuar o Primeiro Registro.',
    mdl_fr_success: 'Primeiro Registro Efetuado com Sucesso.',
  },
  en: {
    ...
    mdl_fr_fail: 'First Registration Failed.',
    mdl_fr_success: 'First Registration Successfully Made.',
